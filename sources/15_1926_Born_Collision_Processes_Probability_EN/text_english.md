"Quantum Mechanics of Collisions," Time. Phys. **38** (1927), 803-827.
...
(²) *W. Heisenberg*, time. Phys. **33** (1925), 879; *M. Born* and *Fr. Jordan*, *ibid.* **34** (1925), 858; *M. Born*, *W. Heisenberg*, and *Fr. Jordan*, *ibid.* **35** (1926), 557. *P. A. M. Dirac*, Proc. Roy. Soc. **109** (1925), 642; **110** (1926), 561.

(³) *E. Schrödinger*, Ann. d. Phys. **79** (1926), 361, 489, 734. Cf., the second paper, pp. 499. **14** (1926), 664.
...
However, nothing will point to our approach in favor of the others as long as we remain within the scope of periodic processes.
...
Now, according to de Broglie, the impulse of the translationy motion that belongs to the eigenfunction (8) is equal to:
...
We seek to solve this equation by the approach:
...
Now, if $W^{e} < h\nu_{10}^{a}$ then $W_{0m}^{e}$ would be negative for $m > 0$, which is impossible; thus, one must have $m = 0$, like this:
...
Naturally, this approach can only be correct for electrons that pass by the atom at the distance considered. We therefore restrict our consideration to electrons for which $r > r_0$ ($^1$), and thus write, from (13), § 6:
...
We now assume that the incoming electrons define a parallel bundle, which corresponds to a plane wave; one will then have:
...
($^2$) S. E. Jahnke and P. Emde, Funktionstafeln, Leipzig, 1909, pp. 19.
...
This consequence of de Broglie's theory was pointed out about a year ago by W. Elsässer $^{(4)}$. When he seriously considered the wave picture, he concluded that the slow

$^{(1)}$ See J. H. van Vleck, Phys. Rev. 23 (1924), 330; Journ. Opt. Soc. Amer. 9 (1924), 27. M. Born and P. Jordan, Time. Phys. 33 (1925), 479.
...
$^{(4)}$ W. Elsasser, Die Naturwiss. 13 (1925), 711. The order of magnitude relationship that Elsässer's argument founded rests upon the de Broglie formula for the wave length:
...
(²) C. Ramsauer, Ann. d. Phys. 64 (1921), 513; 72 (1923), 345. For further literature see Ergebnisse der exakten Naturwissenschaftler, 3 vols. (Berlin, J. Springer, 1924), the article of R. Minkowski and H. Sponer, pp. 67.
